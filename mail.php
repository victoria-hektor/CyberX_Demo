/** 
 * File to accept and process emails with built in error messaging for incorrect user information
**/
...
if ($name == "") {
    ...
    $to = 'cyberx@cybergal.com';
    $subject = 'CyberX Contact Query';
    ...
    $headers .= 'From:  CyberX <cyberx@cybergal.com>' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f cyberx@cybergal.com');
