...
<body class="rbt-header-sticky">
    ...
    <!-- Start Whole Login Area -->
	<div class="rbt-header-sec-col rbt-header-left">
        <div class="rbt-header-content">
             <div class="header-info">
                <div class="logo">
                    <a href="index.html">
                        <div style=text-align: centre;><img src="assets/images/logo/logo-full-black.png" "width="100" alt="CyberX Images"></div>
                    </a>
                </div>
            </div>
        </div>
									...
									<div class="form-submit-group">
										<button type="submit" class="rbt-btn btn-md btn-gradient hover-icon-reverse w-100">
											<span class="icon-reverse-wrapper">
												<a href="member_dashboard.php"><span class="btn-text">Log In</span></a>
                        ...
                        <form action="register_query.php" method="POST">
							<h3 class="title">Register</h3>
								...
								<div class="form-submit-group">
									<button type="submit" class="rbt-btn btn-md btn-gradient hover-icon-reverse w-100">
										<span class="icon-reverse-wrapper">
											<a href="member_dashboard.php"><span class="btn-text">Register</span></a>
											<span class="btn-icon"><i class="feather-arrow-right"></i></span>
											<span class="btn-icon"><i class="feather-arrow-right"></i></span>
										</span>
									</button>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--30">
                        <div class="footer-widget">
                            ...
                            <ul class="ft-link">
                                ...
                                <li><span>E-mail:</span> <a href="mailto:cyber_x@mail.com">cyber_x@mail.com</a></li>
